...
router.post("/crear",verificarToken,verificarRol("Admin"),upload.single("file"),crear);

router.put("/actualizar/:id",verificarToken,verificarRol("Admin"),upload.single("file"),actualizar);
